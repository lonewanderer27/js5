  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        short_name: "JS5",
        name: "JS5",
        description: "JS5 is a compilation of all the numerical methods tools we built as a requirement for Numerical Analysis subject under Sir Ignacio. It consists of 4 tools which each tackle a numerical analysis problem.",
        display: "standalone",
        scope: "/",
        start_url: "/",
        icons: [
