...
import { defaultScreenCSS } from "../RootifyApp";
import { drawerWidth } from "../RootifyApp";
...
export default function About(){
  return (
    ...
    > 
      <Toolbar/>
      <img src="/RootifyApp/logo.png" style={{marginBottom: "20px", height: "100px", width: "auto"}} />
      ...
      <Typography paragraph>
      The third method, Secant, is also available but it is hidden by default. To gain access to the Secant method, just click this url: <a href={`${window.location.pathname}?secant=true`}>{`${window.location.pathname}?secant=true`}</a>
      </Typography>
